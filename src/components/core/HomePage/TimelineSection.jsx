            ...
            <div className=" flex flex-col  lg:flex-row gap-20 mb-20 items-center">
                        ...
                        return (
                            <div className=" flex flex-col lg:gap-3 " key ={index}>
                                ...
                                {/* <div className="flex gap-6"> */}
                                    ...
                                    <div className="w-[50px] h-[50px] bg-white  rounded-full flex justify-center items-center shadow-[#6b393912] shadow-[0_0_62px_0]">
                ...
                <div className="relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]">
                 ...
                 <div className="absolute lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] 
                    ...
                    <div  className=" flex gap-5 items-center lg:px-7">
