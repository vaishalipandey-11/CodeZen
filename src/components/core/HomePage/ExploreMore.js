    ...
    return (
        <div>
           ...
           {/* Sub-Heading text */}
                ...
                p-1'>
                    {
                        tabsName.map((element , index)=>{
                            return (
                                <div className={`text-[16px] flex flex-row items-center gap-9 font-medium 
                                      ${curr === element ? "bg-richblack-900 text-richblack-5 font-medium"
            ...
            {/* {gap Div} */}
            <div className="hidden lg:black lg:h-[200px]"></div>
